...
export default function Mission() {
    return (
        <div className="relative max-w-7xl mx-auto max-md:px-2">
            ...
            <div className="absolute top-0 min-md:left-0 w-[10%] h-1 bg-[#FD9717] animate-fade-in-up hover:bg-orange-600 transition-colors duration-300"></div>
            ...
            <div className="absolute 2xl:top-20 max-md:right-0 min-md:left-70 transform -translate-x-1/2 w-[15%] h-1 bg-[#FD9717] animate-fade-in-up-delay-2 hover:bg-orange-600 transition-colors duration-300"></div>
